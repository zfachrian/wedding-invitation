...
Route::post('/rsvp', 'HomeController@store')->name('rsvp.store');
Route::get('/home', 'HomeController@index')->name('rsvp.index');
Route::get('/main', 'HomeController@main');
// Route::get('/shop', 'ShopController@index');
// Route::get('/shop/{id}', 'ShopController@show');
// Route::get('/shop/category/{id}', 'ShopController@indexByCategory');
...
//   Route::get('/password/reset', 'passwordController@setting')->name('password.setting');
